...
import { clientById, SLA_LEVELS } from '@/mock/data';
  ...
  return (
    <>
      ...
      <PageHead
        ...
        desc={`${c.name} · ${c.contractLevel ?? 'ยังไม่มีสัญญา'}`}
        right={
      ...
      <Card className="mb">
        <div className="card-h">
          <b>ระดับความสำคัญ</b>
          <div className="r">
            <span className="sub">คงที่ 4 ระดับ</span>
          </div>
        </div>
        <table className="tbl">
          <thead>
          ...
          <tbody>
            {SLA_LEVELS.map((l) => (
              <tr key={l.name}>
                ...
                <td>
                  <input className="inp mn" defaultValue={l.respond} style={{ maxWidth: 130 }} />
                </td>
                <td>
                  <input className="inp mn" defaultValue={l.resolve} style={{ maxWidth: 150 }} />
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="grid2">
        <Card>
          ...
          <div className="card-b">
            <label className="chkrow">
              ...
              <span>นับเฉพาะเวลาทำการ (จ–ศ 09:00–18:00)</span>
            </label>
            <label className="chkrow">
              <input type="checkbox" defaultChecked />
              <span>ข้ามวันหยุดราชการไทย</span>
            </label>
            <label className="chkrow">
              <input type="checkbox" defaultChecked />
        ...
        <Card>
          ...
          <div className="card-b">
            <div className="kv">
              <span>เริ่ม</span>
              <b className="mn">14 พ.ค. 2569</b>
            </div>
            <div className="kv">
              <span>สิ้นสุด</span>
              <b className="mn">14 พ.ค. 2570</b>
            </div>
            <div className="kv">
