  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        method: 'PATCH',
        path: '/account',
        summary: 'ชื่อ · ภาษา · รหัสผ่าน (ข้อมูลของคน ไม่ใช่ของที่ทำงาน)',
        scope: 'account',
        milestone: 'M2',
        status: 'live',
      ...
      },
      {
        method: 'POST',
        path: '/account/avatar',
        summary: 'อัปรูปโปรไฟล์ · ส่งเนื้อไฟล์ดิบ สูงสุด 512 KB',
        scope: 'account',
        milestone: 'M2',
        status: 'live',
        note: 'ไม่ใช้ presigned URL เหมือนไฟล์แนบ เพราะเล็กพอที่จะวิ่งผ่านเครื่องได้ และใช้ได้เลยโดยไม่ต้องรอคีย์ที่เก็บไฟล์ · ตรวจชนิดจาก magic bytes ไม่เชื่อ Content-Type และไม่รับ SVG',
      },
      {
        method: 'PUT',
        path: '/account/locale',
        summary: 'สลับภาษา ไทย/อังกฤษ · เขียนทั้งคุกกี้และฐานข้อมูล',
        scope: 'account',
        milestone: 'M2',
        status: 'live',
        note: 'คุกกี้ให้มีผลทันทีทุกหน้ารวมหน้าที่ยังไม่ล็อกอิน · ฐานข้อมูลให้ติดไปกับบัญชีข้ามเครื่อง · คนที่ยังไม่ล็อกอินก็สลับได้ แค่ได้เฉพาะคุกกี้',
      },
      {
        method: 'DELETE',
        path: '/account/avatar',
        summary: 'เอารูปโปรไฟล์ออก กลับไปใช้อักษรย่อ',
        scope: 'account',
        milestone: 'M2',
        status: 'live',
        note: 'ลบรูปของตัวเอง ไม่ใช่ข้อมูลผู้ใช้ในเส้นทางการเงิน จึงไม่ขัดกฎข้อ 7',
      },
    ],
  },
  {
