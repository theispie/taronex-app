...
export const CURRENT_USER = {
  ...
  name: 'ธีรวุฒิ',
  initials: 'ธว',
  email: 'theerawut@digitalx.co.th',
};

export const TENANTS: Tenant[] = [
  {
    code: 'k7m2xq9btr4v',
    name: 'DigitalX Studio',
    status: 'active',
    plan: 'team',
    role: 'owner',
    waitingOnYou: 3,
...
export const PROJECTS: Project[] = [
  {
    ...
    key: 'ACM',
    name: 'เว็บไซต์ Acme',
    clientName: 'บริษัท แอคมี จำกัด',
    pmUserId: 'u1',
    phase: { id: 'ph2', name: 'พัฒนา', kind: 'normal' },
    columnLabels: ['รอทำ', 'กำลังทำ', 'รอตรวจ', 'เสร็จ'],
    typeLabels: ['งาน', 'บั๊ก', 'เอกสาร'],
    memberAccess: 'collaborate',
    baselineTaskCount: 32,
    isArchived: false,
    features: [
  ...
  },
  {
    ...
    pmUserId: 'u1',
    phase: { id: 'ph4', name: 'ประกัน', kind: 'warranty' },
    columnLabels: ['รอทำ', 'กำลังทำ', 'รอตรวจ', 'เสร็จ'],
  ...
  },
  {
    id: 'p3',
    key: 'MKT',
    name: 'แคมเปญเปิดตัว Q3',
    clientName: 'บริษัท แอคมี จำกัด',
    pmUserId: 'u3',
    phase: { id: 'ph1', name: 'วางแผน', kind: 'normal' },
    columnLabels: ['รอทำ', 'กำลังทำ', 'รอตรวจ', 'เสร็จ'],
    board: [
      { key: 'idea', name: 'ตั้งต้น' },
      { key: 'draft', name: 'ร่าง' },
      { key: 'polish', name: 'ขัดเกลา' },
      { key: 'approve', name: 'รออนุมัติ' },
...
export const WEB_TASKS: Task[] = [
  {
    ...
    projectKey: 'TT',
    number: 26,
    title: 'ฟอร์มติดต่อส่งอีเมลไม่ออก',
    columnKey: 'doing',
    type: 'b',
    origin: 'warranty',
    priority: 'critical',
  ...
  },
  {
    ...
    projectKey: 'TT',
    number: 27,
    title: 'อยากเพิ่มหน้าข่าวสารใหม่',
    columnKey: 'todo',
    type: 'a',
    origin: 'warranty',
    priority: 'low',
  ...
  },
  {
    ...
    projectKey: 'TT',
    number: 25,
    title: 'ตรวจสาเหตุ SPF ของโดเมนผู้ส่ง',
    columnKey: 'review',
    type: 'b',
    origin: 'warranty',
    priority: 'high',
...
export interface Notification {
  id: string;
  kind: 'assigned' | 'transferred' | 'rejected' | 'mentioned' | 'sla_warning' | 'client_reported';
  title: string;
  body: string;
  at: string;
  unread: boolean;
...
export const NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    id: 'n2',
    kind: 'sla_warning',
    title: 'TT-026 ใกล้ครบกำหนด',
    body: 'เหลือ 45 นาทีก่อนครบกำหนดตามสัญญา',
    at: 'วันนี้ 09:50',
    unread: true,
  },
  {
    ...
    title: 'ทองไทย มีเดีย แจ้งเรื่องใหม่',
    body: 'รูปหน้าแรกโหลดช้ามาก',
    at: 'วันนี้ 08:15',
    unread: true,
  },
  {
    id: 'n4',
    kind: 'assigned',
    title: 'ได้รับมอบหมาย ACM-136',
    body: 'พีรพล มอบหมาย “เชื่อม Omise” ให้คุณ',
    at: 'เมื่อวาน 16:02',
    unread: false,
  },
  {
    id: 'n5',
    kind: 'mentioned',
    title: 'ถูกพูดถึงใน ACM-134',
    body: '@ณัฐกิตติ์ ช่วยดูขนาดรูปหน้ารายการหน่อย',
    at: 'เมื่อวาน 14:30',
    unread: false,
  },
];
...
export const TEMPLATES: Template[] = [
  {
    ...
    taskCount: 24,
    columns: ['รอทำ', 'กำลังทำ', 'รอตรวจ', 'เสร็จ'],
    types: ['งาน', 'บั๊ก', 'เอกสาร'],
    board: [
      { key: 'backlog', name: 'รอทำ' },
      { key: 'design', name: 'ออกแบบ' },
      { key: 'build', name: 'เขียนโค้ด' },
      { key: 'cr', name: 'รอรีวิวโค้ด' },
      { key: 'uat', name: 'รอลูกค้าตรวจ' },
      { key: 'done', name: 'เสร็จ' },
    ],
  },
  {
  ...
  {
    id: 'tpl-ma',
    name: 'สัญญาดูแลระบบ (MA)',
    owner: 'central',
    features: ['รับเรื่อง', 'คัดแยก', 'แก้ไข', 'ส่งมอบ'],
    taskCount: 8,
    columns: ['รอทำ', 'กำลังทำ', 'รอตรวจ', 'เสร็จ'],
    types: ['งาน', 'เรื่องร้องเรียน', 'เอกสาร'],
  },
  {
    id: 'tpl-blank',
    name: 'เริ่มจากศูนย์',
...
export function columnsOfProject(key: string): BoardColumn[] {
  ...
  return [
    { key: 'todo', name: labels[0] },
    { key: 'doing', name: labels[1] },
    { key: 'review', name: labels[2] },
    { key: 'done', name: labels[3] },
  ] as BoardColumn[];
}
