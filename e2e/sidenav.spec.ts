...
test('เมนูข้างไม่มีป้ายตัวเลขปลอม และหน้าแจ้งเตือนบอกตรงๆ ว่ายังต่อไม่เสร็จ', async ({ page }) => {
  ...
  // ── หน้าแจ้งเตือน ── ว่างจริง และบอกเหตุผล
  ...
  await expect(page.getByText(/ระบบแจ้งเตือนยังต่อไม่เสร็จ/)).toBeVisible();
