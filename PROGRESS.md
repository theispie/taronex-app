...
## ทำต่อ — M5 เครื่องยนต์เปลี่ยนสถานะ ⭐
2 endpoint แต่เป็นหัวใจของทั้งระบบ · `POST /tasks/:id/transition`
กติกาคำนวณสดจากตำแหน่งและทิศทางการลาก · `withColumnMove()` เตรียมไว้แล้ว
**ผ่านเมื่อ** ลากถอยหลังต้องมีเหตุผล · เข้าคอลัมน์สุดท้าย PM เท่านั้น ·
การ์ดกลับไปหาเจ้าของคนก่อนตอนตีกลับ (อ่านจาก `task_events`)

### หน้าจอ M4 ที่ยังไม่ได้ต่อ
18 มุมมองตาราง · 20 รายละเอียดทิกเก็ต · 21 สร้างทิกเก็ต · 37 ไฟล์ของโปรเจกต์
API พร้อมครบแล้ว เหลือแค่ต่อ
